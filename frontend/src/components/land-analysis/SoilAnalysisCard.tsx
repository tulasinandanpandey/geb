    ...
    <div className="bg-white border border-slate-200/90 rounded-3xl p-5 shadow-md space-y-6 text-slate-800 font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">Safe load: {analysis.bearing_capacity_kpa} kN/m²</p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">Soil pH: {analysis.soil_ph} (Neutral)</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3.5">
          <p className="text-slate-400 text-[11px] font-bold">Safe Bearing Capacity</p>
          <p className="text-base font-extrabold text-emerald-700 mt-1">{analysis.bearing_capacity_kpa} kN/m²</p>
          <p className="text-[10px] text-slate-500 mt-0.5 font-medium">Allows 2-5 Stories</p>
        </div>

        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3.5">
          <p className="text-slate-400 text-[11px] font-bold">Water Table Depth</p>
          <p className="text-base font-extrabold text-sky-700 mt-1">{analysis.water_table_depth_m} meters</p>
          <p className="text-[10px] text-slate-500 mt-0.5 font-medium">Below Ground Level</p>
        </div>

        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3.5">
          <p className="text-slate-400 text-[11px] font-bold">Soil pH Level</p>
          <p className="text-base font-extrabold text-amber-700 mt-1">{analysis.soil_ph}</p>
          <p className="text-[10px] text-slate-500 mt-0.5 font-medium">Optimal Availability</p>
        </div>

        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3.5">
          <p className="text-slate-400 text-[11px] font-bold">Flood Risk Level</p>
          <p
          ...
          <p className="text-[10px] text-slate-500 mt-0.5 font-medium">Slope: {analysis.slope_percent}%</p>
        </div>
      </div>
      ...
      <div className="space-y-3 bg-slate-50 border border-slate-200 rounded-2xl p-4 text-xs">
        <div>
          ...
          <p className="text-slate-900 font-bold mt-1">{analysis.recommended_foundation}</p>
        </div>
        ...
        <div className="pt-2 border-t border-slate-200">
          ...
          <div className="flex flex-wrap gap-1.5 mt-1.5">
            {analysis.suitable_crops.map((crop, i) => (
              <span
                key={i}
                className="px-2.5 py-1 rounded-full bg-sky-100 text-sky-800 border border-sky-200 font-extrabold text-[10px]"
              >
                {crop}
              </span>
            ))}
        ...
        {analysis.soil_remediation_notes && (
          <div className="pt-2 border-t border-slate-200 text-slate-700">
            ...
            <p className="text-slate-600 text-[11px] mt-1 font-medium">{analysis.soil_remediation_notes}</p>
          </div>
        )}
      </div>
