...
function mapProperty(
  ...
  return {
    ...
    propertyType:
      property.property_type as Property["propertyType"],
    ...
    source:
      property.source as Property["source"],

    sourceName:
      property.source_name ?? "",

    sourceUrl:
      property.source_url ?? undefined,

    investmentScore:
      property.investment_score ?? undefined,

    featured:
      property.featured ?? false,

    status:
      property.status as Property["status"],

    description:
      property.description ?? undefined,

    sellerId:
      property.seller_id ?? undefined,
...
export async function getMyProperties(): Promise<Property[]> {
  ...
  if (!response.ok) {
    ...
    throw new Error(
      error?.detail ||
      `Failed to fetch your properties: ${response.status}`
    );
  }
