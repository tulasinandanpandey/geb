    ...
    <div className="bg-white border border-[var(--stone-line)]/90 rounded-3xl p-5 shadow-md space-y-6 text-[var(--ink)] font-sans">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 border-b border-[var(--stone-line)] pb-4">
        <div>
          ...
          <p className="text-xs text-[var(--ink-soft)] font-medium mt-0.5">{air.health_impact}</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-[var(--paper)] border border-[var(--stone-line)] rounded-2xl p-4 flex items-center gap-4 shadow-sm">
          <div className="relative flex items-center justify-center">
            ...
            <span className="absolute text-sm font-extrabold text-orange-900">{air.aqi}</span>
          </div>
          <div>
            ...
            <p className="text-sm font-extrabold text-[var(--ink)] mt-0.5">{air.aqi_category} Range</p>
            <p className="text-[11px] text-[var(--ink-soft)] font-medium">PM2.5: {air.pm25_ug_m3} µg/m³</p>
          </div>
        </div>
        ...
        <div className="bg-[var(--paper)] border border-[var(--stone-line)] rounded-2xl p-4 flex items-center gap-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[11px] text-[var(--ink-soft)] font-medium">Green Buffer: {air.green_belt_buffer_km} km</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
        <div className="bg-[var(--paper)] border border-[var(--stone-line)] rounded-2xl p-3.5">
          <p className="text-[var(--ink-soft)] text-[11px] font-bold">PM 2.5 Fine Particles</p>
          <p className="text-base font-extrabold text-orange-700 mt-1">{air.pm25_ug_m3} µg/m³</p>
          <p className="text-[10px] text-[var(--ink-soft)] mt-0.5 font-medium">Standard &lt;60</p>
        </div>

        <div className="bg-[var(--paper)] border border-[var(--stone-line)] rounded-2xl p-3.5">
          <p className="text-[var(--ink-soft)] text-[11px] font-bold">PM 10 Coarse Particulate</p>
          <p className="text-base font-extrabold text-indigo-700 mt-1">{air.pm10_ug_m3} µg/m³</p>
          <p className="text-[10px] text-[var(--ink-soft)] mt-0.5 font-medium">Standard &lt;100</p>
        </div>

        <div className="bg-[var(--paper)] border border-[var(--stone-line)] rounded-2xl p-3.5">
          <p className="text-[var(--ink-soft)] text-[11px] font-bold">Monsoon Season AQI</p>
          <p className="text-base font-extrabold text-emerald-700 mt-1">{air.seasonal_monsoon_aqi}</p>
          <p className="text-[10px] text-[var(--ink-soft)] mt-0.5 font-medium">Cleanest Season</p>
        </div>

        <div className="bg-[var(--paper)] border border-[var(--stone-line)] rounded-2xl p-3.5">
          <p className="text-[var(--ink-soft)] text-[11px] font-bold">Winter Peak AQI</p>
          <p className="text-base font-extrabold text-amber-700 mt-1">{air.seasonal_winter_aqi}</p>
          <p className="text-[10px] text-[var(--ink-soft)] mt-0.5 font-medium">Inversion Season</p>
        </div>
      </div>
